...
Growy is an app for diligent kids that tracks their chores and progresses, and encourage them to mantain good behaviour and learn new tasks giving them satisfaction and little treats.
...
- Login with pin
- List of daily chores (common tasks can have some explanation to how to be performed)
- List of new skill learned (bit archievements such learning to ride a bike or to load a washing machine)
